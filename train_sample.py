...
args.data = 'SampleEdf'
args.root_path = '/home/wellysis-tft/Desktop/pipeline/edf_sampler/normal_sample'
args.data_path = None  # '2020-08-03.edf'
args.features = 'S' # forecasting task, options:[M, S, MS]; M:multivariate predict multivariate, S:univariate predict univariate, MS:multivariate predict univariate
args.target = 'OT' # target feature in S or MS task
args.freq = 'h' # freq for time features encoding, options:[s:secondly, t:minutely, h:hourly, d:daily, b:business days, w:weekly, m:monthly], you can also use more detailed freq like 15min or 3h
args.checkpoints = './informer_checkpoints' # location of model checkpoints

args.seq_len = 2560  # input sequence length of encoder
args.label_len = 1280  # start token length of decoder
args.pred_len = 1280  # prediction sequence length of decoder
